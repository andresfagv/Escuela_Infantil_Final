...
require_once("../../models/models_admin/admin_listar_autorizaciones_m.php");
...
if ($id_estudiante) {
    ...
    if ($documentos) {
        ...
        foreach ($documentos as $documento) {
            ...
            echo '<td><a href="../../controllers/controllers_admin/admin_listar_autorizaciones_c.php?action=delete&id=' . $documento['id'] . '&id_estudiante=' . $id_estudiante . '" onclick="return confirmarEliminacion();">Eliminar</a></td>';
            echo '</tr>';
        }
        echo '</tbody>';
        echo '</table>';
...
switch ($action) {
    case 'delete':
        ...
        if ($id) {
            ...
            ob_end_clean();
            header('Location: ../../controllers/controllers_admin/admin_listar_autorizaciones_c.php');
            exit();
        }
        break;
    case 'add':
    ...
    default:
        if (!$id_estudiante) {
            ...
            include '../../views/views_admin/admin_listar_autorizaciones_v.php';
        }
        break;
}
