...
require_once("../../models/models_educador/educador_listar_galeria_m.php");
...
if ($idClase) {
    ...
    if ($fotos) {
        ...
        foreach ($fotos as $foto) {
            ...
            echo '<td><a href="../../controllers/controllers_educador/educador_listar_galeria_c.php?action=delete&id=' . $foto['id'] . '&id_clase=' . $idClase . '" onclick="return confirmarEliminacion();">Eliminar</a></td>';
            echo '</tr>';
        }
        echo '</tbody>';
        echo '</table>';
...
switch ($action) {
    case 'delete':
        ...
        if ($id) {
            eliminarFoto($id);
            header('Location: ../../controllers/controllers_educador/educador_listar_galeria_c.php');
            exit();
        }
        break;
    case 'add':
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            if ($seguir) {
                ...
                echo "<script>window.location.href = '../../controllers/controllers_educador/educador_listar_galeria_c.php';</script>";
            }
        }
        break;
    default:
        if (!$idClase) {
            ...
            include '../../views/views_educador/educador_listar_galeria_v.php';
        }
        break;
}
