...
<body>
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h2>Gestor de Autorizaciones</h2>
                    </div>
                </div>
                <!-- /. ROW  -->
                <hr />
                <div class="row">
                    ...
                    <div id="formularioContacto" style="display:none;">
                        ...
                        <form method="POST" action="../../controllers/controllers_admin/admin_listar_autorizaciones_c.php?action=add" enctype="multipart/form-data">
    ...
    <script src="../../js/admin/admin_ajax_autorizacion.js"></script>
