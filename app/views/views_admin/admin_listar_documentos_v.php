...
<body>
            ...
            <div id="page-inner">
                ...
                <div class="row">
                    ...
                    <div id="formularioContacto" style="display:none;">
                        ...
                        <form method="POST" action="../../controllers/controllers_admin/admin_listar_documentos_c.php?action=add" enctype="multipart/form-data">
    ...
    <script src="../../js/admin/admin_ajax_documentos.js"></script>
