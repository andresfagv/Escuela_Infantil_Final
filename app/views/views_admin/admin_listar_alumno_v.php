                                        ...
                                        <?php if ($datos_estudiantes) : ?>
                                            <?php foreach ($datos_estudiantes as $dato_estudiante) : ?>
                                                <tr>
                                                    ...
                                                    <td><a href="../../controllers/controllers_admin/admin_datos_alumno_c.php?id=<?= $dato_estudiante['id'] ?>"><?= $dato_estudiante['nombre_estudiante'] . " " . $dato_estudiante['apellido_estudiante'] ?></a></td>
                                                    <td><?= $dato_estudiante['f_nacimiento'] ?></td>
                                                    <td><?= $dato_estudiante['Clase'] ?></td>
                                                    <td><?= $dato_estudiante['Tutor Legal'] ?></td>
                                                    <td><?= $dato_estudiante['Telef. Contacto'] ?></td>
                                                    <td><a href="../../controllers/controllers_admin/admin_editar_alumno_c.php?id=<?= $dato_estudiante['id'] ?>">Editar</a></td>
                                                    <td><a href="../../controllers/controllers_admin/admin_listar_alumnos_c.php?action=delete&id=<?= $dato_estudiante['id'] ?>" onclick="return confirmarEliminacion();">Eliminar</a></td>
                                                </tr>
